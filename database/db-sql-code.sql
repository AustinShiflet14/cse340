...
--create the relationship between inventory and classification tables
...
-- Relationship between account and favorites
...
-- Relationship between inventory and favorites
ALTER TABLE public.favorites
    ADD CONSTRAINT favorites_inv_id_fkey
    FOREIGN KEY (inv_id)
    REFERENCES public.inventory (inv_id)
    ON DELETE CASCADE;

CREATE UNIQUE INDEX favorites_unique_pair
